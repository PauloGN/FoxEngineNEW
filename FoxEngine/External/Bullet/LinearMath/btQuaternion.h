...
//////////////////////////////////////////////////////////////////////
#pragma region FOXENGINE
	operator FoxEngine::FoxMath::Quaternion() const { return { m_floats[0], m_floats[1], m_floats[2], m_floats[3] }; }
	btQuaternion& operator=(const FoxEngine::FoxMath::Quaternion& rhs)
	{
		m_floats[0] = rhs.x;
		m_floats[1] = rhs.y;
		m_floats[2] = rhs.z;
	...
	btQuaternion(const FoxEngine::FoxMath::Quaternion& other)
	{
		m_floats[0] = other.x;
		m_floats[1] = other.y;
		m_floats[2] = other.z;
