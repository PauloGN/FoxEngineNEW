...
#pragma region FOXENGINE 
	operator FoxEngine::FoxMath::Vector3() const { return { m_floats[0], m_floats[1], m_floats[2] }; }
	btVector3& operator=(const FoxEngine::FoxMath::Vector3& rhs)
	{
		m_floats[0] = rhs.x;
		m_floats[1] = rhs.y;
		m_floats[2] = rhs.z;
	...
	btVector3(const FoxEngine::FoxMath::Vector3& other)
	{
		m_floats[0] = other.x;
		m_floats[1] = other.y;
		m_floats[2] = other.z;
